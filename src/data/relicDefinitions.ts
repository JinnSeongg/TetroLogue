...
export const relicDefinitions: Record<string, RelicDefinition> = {
  ...
  fast_power: {
    id: "fast_power",
    name: "Fast 효율 증가",
    description: "Fast Chain 1당 공격 피해 보너스가 1%p 증가합니다.",
    ...combatRelic("speed", "common"),
    tags: ["attack", "speed", "fast"],
    modifiers: [{ trigger: "passive", speedBonusPerStackAdd: 0.01 }],
  },
  holdless_focus: {
    id: "holdless_focus",
    name: "Hold 미사용 공격 강화",
  ...
  fast_strong_attack: {
    ...
    name: "Fast 고속 추가타",
    description: "Fast Chain이 20 이상이면 추가 피해 +2를 더합니다.",
    ...combatRelic("speed", "rare"),
    tags: ["attack", "speed", "fast"],
    modifiers: [{ trigger: "onAttackCalculated", flatBonusAdd: 2, when: { fastChain: { gte: 20 } } }],
  },
  fast_combo_bonus: {
    id: "fast_combo_bonus",
    name: "Fast 콤보 보너스",
    description: "Fast Chain이 10 이상이고 Combo 공격이면 comboDamage +1을 더합니다.",
    ...combatRelic("speed", "uncommon"),
    tags: ["attack", "speed", "fast", "combo", "flatBonus"],
    modifiers: [{ trigger: "onAttackCalculated", comboDamageAdd: 1, when: { fastChain: { gte: 10 }, combo: { gte: 2 } } }],
  },
  fast_line_bonus: {
    id: "fast_line_bonus",
    name: "Fast 줄제거 추가타",
    description: "Fast Chain이 10 이상이고 줄 제거 공격이면 추가 피해 +1을 더합니다.",
    ...combatRelic("speed", "common"),
    tags: ["attack", "speed", "fast", "flatBonus"],
    modifiers: [{ trigger: "onAttackCalculated", flatBonusAdd: 1, when: { fastChain: { gte: 10 }, linesCleared: { gte: 1 } } }],
  },
  fast_tspin_power: {
    id: "fast_tspin_power",
    name: "Fast T-spin 강화",
    description: "Fast Chain이 10 이상이고 T-spin 공격이면 기본 공격 피해가 25% 증가합니다.",
    ...combatRelic("speed", "uncommon"),
    tags: ["attack", "speed", "fast", "spin", "tSpin"],
    modifiers: [{ trigger: "onAttackCalculated", typeBonusAdd: 0.25, when: { fastChain: { gte: 10 }, isTSpin: true } }],
  },
  garbage_absorb: {
    id: "garbage_absorb",
    name: "대기 Garbage 강화",

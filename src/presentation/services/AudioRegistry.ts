...
export const audioRegistry: Record<SoundEventKey, SoundDefinition> = {
  ...
  rotate: { src: `${sfx}/piece-rotate-2.mp3`, group: "sfx", minIntervalMs: 70, maxConcurrent: 1 },
  softDrop: { src: `${sfx}/piece-move.mp3`, group: "sfx", minIntervalMs: 95, maxConcurrent: 1 },
  hardDrop: { group: "sfx" },
  ...
  double: { src: `${sfx}/clear-double.mp3`, group: "sfx", fallback: "clear", minIntervalMs: 80, maxConcurrent: 2 },
  triple: { src: `${sfx}/clear-triple.mp3`, group: "sfx", fallback: "clear", minIntervalMs: 80, maxConcurrent: 2 },
  tetris: { src: `${sfx}/clear-tetris.mp3`, group: "sfx", fallback: "clear", minIntervalMs: 100, maxConcurrent: 1 },
  tspin: { src: `${sfx}/combo-chain.mp3`, group: "sfx", fallback: "tetris", minIntervalMs: 100, maxConcurrent: 1 },
  combo: { src: `${sfx}/t-spin.mp3`, group: "sfx", minIntervalMs: 90, maxConcurrent: 2 },
  backToBack: { src: `${sfx}/t-spin.mp3`, group: "sfx", fallback: "combo", minIntervalMs: 120, maxConcurrent: 1 },
  perfectClear: { src: `${sfx}/all-clear.mp3`, group: "sfx", fallback: "tetris", minIntervalMs: 160, maxConcurrent: 1 },
  attack: { src: `${sfx}/hard-drop.mp3`, group: "sfx", minIntervalMs: 90, maxConcurrent: 2 },
  hit: { src: `${sfx}/piece-lock.mp3`, group: "sfx", minIntervalMs: 80, maxConcurrent: 2 },
  danger: { src: `${sfx}/garbage-rise.mp3`, group: "ui", minIntervalMs: 500, maxConcurrent: 1 },

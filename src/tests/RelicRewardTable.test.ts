...
describe("Relic reward tables", () => {
  it("includes combatReward relics in the combat reward table", () => {
    ...
    expect(combatRelicIds()).toContain("consecutive_tetris_power");
    expect(combatRelicIds()).toContain("tetris_cancel_bonus");
    expect(combatRelicIds()).toContain("tspin_followup_power");
    expect(combatRelicIds()).toContain("consecutive_tspin_power");
    expect(combatRelicIds()).toContain("consecutive_tspin_flat");
    expect(combatRelicIds()).toContain("tspin_cancel_bonus");
    expect(combatRelicIds()).toContain("b2b_cancel_bonus");
    expect(combatRelicIds()).toContain("stable_field_cancel_bonus_1");
    expect(combatRelicIds()).toContain("stable_field_cancel_bonus_2");
    expect(combatRelicIds()).toContain("pc_followup_bonus");
    expect(combatRelicIds()).toContain("pc_timed_base_power");
    expect(combatRelicIds()).toContain("hole_gravity_relief");
    expect(combatRelicIds()).toContain("hole_gravity_relief_2");
    expect(combatRelicIds()).toContain("hole_lock_delay");
